...
class bank:
    def __init__(self,root):
        ...
        self.frame1.pack()
        self.button1=Button(self.frame1,text='WELCOME TO MOHAN BANK',font=('roman',70,'bold italic'),width=500,height=2,bg='white',fg='black')
        self.text1=Text(self.frame1,width=100,height=10,font=('verdana',14,'bold'),bg='white',fg='black')
        self.text1.insert(END,'YOU ARE IN MOHAN BANK\n\t AND THE FOUNDER OF THIS BANK IS MOHAN KUMAR KV \n\t\t\t if you want to continue press continue')
        self.button2=Button(self.frame1,text='CONTINUE',font=('verdana',14,'bold'),width=10,height=3,bg='blue',fg='black',command=self.user)
        self.button3=Button(self.frame1,text='exit',font=('verdana',14,'bold'),width=7,height=2,bg='blue',fg='black',command=quit)
        self.button1.pack()
        self.text1.pack()
        self.button2.pack()
    ...
    def user(self):
        ...
        self.button4=Button(self.frame1,text='LOGIN',font=('verdana',10,'bold'),width=14,height=2,bg='pink',fg='black',command=self.olduser)
        ...
        self.button5=Button(self.frame1,width=14,height=2,text='SIGN IN',font=('verdana',10,'bold'),bg='pink',fg='black',command=self.newuser)
    ...
    def olduser(self):
        ...
        self.button7=Button(self.frame1,width=13,height=2,text='<<== BACK',fg='blue',font=('verdana',10,'bold'),command=self.user)
    ...
    def match(self,eno,password):
        ...
        if res==1:
            ...
            self.button3=Button(self.frame1,text='NEXT -->',width=20,height=1,bg='blue',fg='black',command=self.language)
            self.button3.place(x=500,y=600)
        elif res==0:
            lbl=Label(text='ACCOUNT NUMBER AND PASSWORD IS NOT MATCHING RETRY',font=('arial',14)).place(x=300,y=400)
            self.button3=Button(self.frame1,text='RETRY',width=10,height=1,bg='blue',fg='black',command=self.olduser)
            self.button3.place(x=500,y=600)
    ...
    def language(self):
        ...
        self.button8 = Button(self.frame1, width=9, height=2, text='ENGLISH',fg='dark blue', font=('verdana', 13, 'bold'),command=self.acctype)
        self.button8.place(x=800, y=300)
        self.button9=Button(self.frame1,width=9,height=2,text='KANNADA',fg='dark blue',font=('verdana',13,'bold'))
        self.button9.place(x=800,y=379)
        self.button10=Button(self.frame1,width=9,height=2,text='HINDI',fg='dark blue',font=('verdana',13,'bold'))
        self.button10.place(x=800,y=460)
        self.button7=Button(self.frame1,width=13,height=2,text='<<== BACK',fg='blue',font=('verdana',10,'bold'),command=self.olduser)
        self.button7.place(x=30,y=500)
    ...
    def acctype(self):
        ...
        self.text5.place(x=250, y=20)
        self.button11=Button(self.frame1,width=15,height=1,text='SAVING ACCONT',fg='white',bg='black',font=('verdana',17,'bold'),command=self.operation)
        self.button11.place(x=800,y=300)
        self.button12=Button(self.frame1,width=15,height=1,text='CURRENT ACCONT',bg='black',fg='white',font=('verdana',17,'bold'))
        self.button12.place(x=800,y=400)
        self.button7=Button(self.frame1,width=13,height=2,text='<<== BACK',fg='blue',font=('verdana',10,'bold'),command=self.language)
        self.button7.place(x=30,y=500)
    def operation(self):
        self.frame1.destroy()
        self.frame1=Frame(root,width=5000,height=5000)
        ...
        self.text5.place(x=250, y=20)
        self.button13=Button(self.frame1,width=15,height=1,text='WITHDRAW',fg='white',bg='black',font=('verdana',17,'bold'),command=self.withdraw)
        self.button13.place(x=800,y=300)
        self.button13=Button(self.frame1,width=15,height=1,text='BALANCE',fg='white',bg='black',font=('verdana',17,'bold'),command=self.balance)
        self.button13.place(x=800,y=400)
        self.button15=Button(self.frame1,width=15,height=1,text='DEPOSIT',fg='white',bg='black',font=('verdana',17,'bold'),command=self.deposit)
        self.button15.place(x=800,y=600)
        self.button14=Button(self.frame1,width=15,height=1,text='MINI STATEMENT',fg='white',bg='black',font=('verdana',17,'bold'))
        self.button14.place(x=800,y=500)
        self.button7=Button(self.frame1,width=13,height=2,text='<<== BACK',fg='blue',font=('verdana',10,'bold'),command=self.acctype)
        self.button7.place(x=30,y=500)
    ...
    def insert(self,eno,password,ename,balance):
        ...
        lb2=Label(text='IF YOU WANT TO CONTINUE THEN LOGIN TO YOUR ACCOUNT --------->',font=('Arial',14)).place(x=20,y=600)
        self.button4=Button(self.frame1,text='LOGIN -->',font=('verdana',10,'bold'),width=14,height=2,bg='pink',fg='black',command=self.olduser)
    ...
    def withdraw(self):
        ...
        self.button7=Button(self.frame1,width=13,height=2,text='<<== BACK',fg='blue',font=('verdana',10,'bold'),command=self.operation)
        self.button7.place(x=30,y=500)
